            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="lg:hidden mt-10 mb-2 mx-6 rounded-3xl overflow-hidden relative h-52 shadow-xl">
                    ...
                    <div className="absolute bottom-6 left-6 right-6 z-20">
                        <h3 className="text-2xl font-display font-bold text-white leading-tight">Our Digital Portfolio</h3>
                        <p className="text-white/70 text-sm font-medium mt-1">Scalable, visually spectacular products.</p>
                    </div>
                </div>
                ...
                <motion.div
                    className="flex mt-12 justify-center w-full px-6"
