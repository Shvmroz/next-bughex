        ...
        <section className="py-12 md:py-24 bg-[#FAFBFC] relative">
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 mt-16 items-start relative">
                    {/* LEFT PANEL - STICKY MEDIA (Desktop only) */}
                    ...
                    <div className="w-full lg:w-1/2 flex flex-col gap-8 lg:gap-10">
                        <div className="h-[500px] overflow-y-auto pr-2 scrollbar-hide lg:h-auto lg:overflow-visible lg:pr-0">
                ...
                {/* VIEW ALL BUTTON - MOVED OUTSIDE FLEX ROW */}
                <motion.div
                ...
                >
                    <Link href="/projects" className="w-full sm:w-auto">
                        <button className="btn w-full sm:w-auto h-[48px] px-12 text-[11px] lg:text-xs tracking-[0.2em] shadow-xl group">
