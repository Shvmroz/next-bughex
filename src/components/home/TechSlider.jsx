...
const techRow1 = [
  ...
  { name: "Laravel / PHP", icon: "logos:laravel", color: "#FF2D20" },
...
const techRow2 = [
  ...
  { name: "Material UI", icon: "logos:material-ui", color: "#007FFF" },
...
function TechCard({ tech }) {
  return (
    <div className="flex flex-row items-center gap-5 px-8 py-4 rounded-[6px] mx-3 flex-shrink-0 group transition-all duration-300 relative bg-white border border-gray-100 hover:border-gray-200 hover:shadow-md overflow-hidden h-20">
      ...
      <Icon
        ...
        className="drop-shadow-sm flex-shrink-0 relative z-10"
      />
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 80% 60% at 50% 50%, rgba(27,181,162,0.06) 0%, transparent 70%)",
        }}
      />
      <div className="absolute inset-0 grid-bg opacity-10" />

      <SectionHeader tag="Our Stack" title="We Specialized" />
