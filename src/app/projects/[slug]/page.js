...
import { getBlogBySlug, blogs } from '@/lib/mock';
        ...
        <section className="pb-16 relative">
          <div className="max-w-4xl mx-auto px-6">
            <motion.div
              ...
              style={{
                background:
                  'linear-gradient(135deg, rgba(24, 214, 191, 0.12), rgba(24, 214, 191, 0.03))',
            ...
            <div className="mt-16 pt-8 border-t border-gray-100 flex flex-col gap-4">
              <p className="text-xs text-dark/30 uppercase tracking-[0.2em] font-bold">Tags</p>
